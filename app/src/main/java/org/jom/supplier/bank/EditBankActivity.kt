...
import org.jom.supplier.address.EditEstateApi
import org.jom.supplier.address.EditEstateFormData
import org.jom.supplier.address.ViewAddressActivity
...
data class EditAccountFormData(
    val id: Int,
    val name: String,
    val nickName: String,
...
class EditBankActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        account_number.setText(extras.getString("account_number"))
        bank.setText(extras.getString("bank"))
        ...
        save.setOnClickListener {
            ...
            nickName_status_func(account_number.text.toString())
            ...
            if (name_status && nickName_status && nickName_status && bank_status) {
                ...
                val intent = Intent(this, ViewBankActivity::class.java)
                ...
                val editAccountApi = retrofit.create(EditAccountApi::class.java)

                val formData = EditAccountFormData(
                    id = id,
                ...
                if (formData != null) {
                    editAccountApi.editAccount(formData)
                        .enqueue(object : retrofit2.Callback<ResponseBody> {
                            ...
                            override fun onResponse(
                                ...
                                if (response.code() == 200) {
                                    ...
                                    Log.d("TAG", "Cannot update account")
